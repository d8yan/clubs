...
{
    public class DYInstrumentController : Controller
    {
        private readonly ClubsContext _context;

        public DYInstrumentController(ClubsContext context)
        {
            _context = context;
        }
        ...
        // GET: DYInstrument/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: DYInstrument/Create
