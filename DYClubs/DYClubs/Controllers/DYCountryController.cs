 ...
 * Revision History: on September 17,2020 
 */
using System;
...
{
    public class DYCountryController : Controller
    {
        private readonly ClubsContext _context;

        public DYCountryController(ClubsContext context)
        {
            _context = context;
        }
        ...
        // GET: DYCountry/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: DYCountry/Create
